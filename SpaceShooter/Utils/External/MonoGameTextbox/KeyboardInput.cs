...
namespace SpaceShooter.Utils.External.MonoGameTextbox {
	/// <summary>
	...
	public static class KeyboardInput {
		...
		public static readonly char[] SpecialCharacters = {'\a', '\b', '\n', '\r', '\f', '\t', '\v'};
		...
		private static void TextEntered(object sender, TextInputEventArgs e) {
			if(CharPressed != null) {
				if(!filterSpecialCharacters || !SpecialCharacters.Contains(e.Character)) {
